import { fazRequisicao, imprimirErro, verificarErros } from "./util.js";
...
formAluno.addEventListener('submit', async e => {
    ...
    limparSpans()
    fazRequisicao('processaAluno.php', 'POST', aluno)
    .then( async resp=>{
        return await verificarErros(resp);
    })
    .then( aluno => preencherDados(aluno))
    .catch( erro => imprimirErro(spanErro, erro.message, 3000))
})
